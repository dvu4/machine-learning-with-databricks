...
# MAGIC - Compare trials in the [MLflow experiment](#mlflow/experiments/4297320214106150).
...
input_data_path = mlflow.artifacts.download_artifacts(run_id="7322317e600746d68566d4eb788f859e", artifact_path="data", dst_path=input_temp_dir)
...
feature_spec_path = "runs:/7322317e600746d68566d4eb788f859e/data/feature_spec.yaml"
...
# MAGIC - All the runs are logged under [this MLflow experiment](#mlflow/experiments/4297320214106150)
...
def objective(params):
  with mlflow.start_run(experiment_id="4297320214106150") as mlflow_run:
...
space = {
  ...
  "learning_rate": 0.6277240153815767,
  "max_depth": 5,
  "min_child_weight": 9,
  "n_estimators": 25,
  "n_jobs": 100,
  "subsample": 0.4703903937481246,
  "verbosity": 0,
  "random_state": 925372259,
}
...
if shap_enabled:
    ...
    train_sample = X_train.sample(n=min(100, X_train.shape[0]), random_state=925372259).fillna(mode)

    # Sample some rows from the validation set to explain. Increase the sample size for more thorough results.
    example = X_val.sample(n=min(100, X_val.shape[0]), random_state=925372259).fillna(mode)
...
displayHTML(f"<a href=#mlflow/experiments/4297320214106150/runs/{ mlflow_run.info.run_id }/artifactPath/model> Link to model run page </a>")
