...
# MAGIC - Explore completed trials in the [MLflow experiment](#mlflow/experiments/4297320214106150).
...
training_data_path = mlflow.artifacts.download_artifacts(run_id="7322317e600746d68566d4eb788f859e", artifact_path="data", dst_path=temp_dir)
